            ...
            <div className="card" onClick={() => openModal(props.id)}>
                <div className="all-content">
                    ...
                    <div className="back-content">
                        {props.creator ? <span class="material-symbols-outlined" id="exercise-icon">group</span>
                        : <span class="material-symbols-outlined" id="exercise-icon">exercise</span>}
                    ...
                    <div className="front-content">
                        <small className="badge">Workout</small>
